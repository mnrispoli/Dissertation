...
ax1.errorbar(kdm0dat[::,0]*1E3,kdm0dat[::,1],yerr=kdm0dat[:,2], fmt='o',\
             markersize=mksz, linewidth = lw, zorder = 1, label = 'nu=0',\
             color = matica99A)
...
ax1.legend(frameon=False, loc=(0.275,-0.225), ncol=3)
