...
ax1.plot(xx/2/np.pi,wn0[::,wn0Inds[1]]-0.25, lw=2, zorder = 3, label=str(VoN[wn0Inds[1]])+' Er' )
ax1.plot(xx/2/np.pi,wn0[::,wn0Inds[2]]-0.25, lw=2, zorder = 2, label=str(VoN[wn0Inds[2]])+' Er' )
ax1.plot(xx/2/np.pi,wn0[::,wn0Inds[3]]-0.25, lw=2, zorder = 1, label=str(VoN[wn0Inds[3]])+' Er' )
ax1.set_xlim([XL, XH])
...
ax2.plot(xx/2/np.pi,wn0[::,VPind]/3.0, lw=2)
ax2.plot(xx/2/np.pi,wn1[::,VPind]/3.0+2*1.0/3, lw=2)
ax2.plot(xx/2/np.pi,wn2[::,VPind]/3.0+2*2.0/3, lw=2)
ax2.plot(xx/2/np.pi,wn3[::,VPind]/3.0+2*3.0/3, lw=2)
