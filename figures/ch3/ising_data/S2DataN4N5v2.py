...
S2N5Thry = np.genfromtxt('4SiteData/S2_Thry_N4.csv', delimiter = ',')
S2N5Data = np.genfromtxt('4SiteData/S2Data_N4.csv', delimiter = ',')

gvals = np.genfromtxt('4SiteData/g_vals_data.csv', delimiter = ',')

NeelN5Data = np.genfromtxt('4SiteData/N4_NeelOrder_Data.csv', delimiter = ',')
NeelN5Thry = np.genfromtxt('4SiteData/N4_NeelOrder_Thry.csv', delimiter = ',')
...
AFM3Data = np.genfromtxt('4SiteData/AFMData_N4.csv', delimiter = ',')
AFM3Thry = np.genfromtxt('4SiteData/AFMThry_N4.csv', delimiter = ',')
...
ax1.errorbar(PMData[::,0],PMData[::,1],yerr=PMData[:,2], fmt='o',\
             markersize=mksz, linewidth = lw, zorder = 40, \
             label = 'Data', color = matica99A)
ax1.plot(PMData[::,0],PMData[::,1],'o', color='white', markersize=2, zorder = 41 )

ax1.plot(PMThry[::,0],PMThry[::,1], zorder = 4,ls='-', \
         color = blendClr(matica99A,clrWhite,0.5),linewidth=lws)




#ax1.errorbar(AFM1Data[::,0],AFM1Data[::,1],yerr=AFM1Data[:,2], fmt='o',\
#             markersize=mksz, linewidth = lw, zorder = 40,\
#             label = 'Data', color = matica99B)
#ax1.plot(AFM1Data[::,0],AFM1Data[::,1],'o', \
#         color='white', markersize=2, zorder = 41 )
#
#ax1.plot(AFM1Thry[::,0],AFM1Thry[::,1], zorder = 4,ls='-', \
#         color = blendClr(matica99B,clrWhite,0.5),linewidth=lws)
#
#
#
#ax1.errorbar(AFM2Data[::,0],AFM2Data[::,1],yerr=AFM2Data[:,2], fmt='o',\
#             markersize=mksz, linewidth = lw, zorder = 40, \
#             label = 'Data', color = matica99G)
#ax1.plot(AFM2Data[::,0],AFM2Data[::,1],'o', color='white', \
#         markersize=2, zorder = 41 )
#
#ax1.plot(AFM2Thry[::,0],AFM2Thry[::,1], zorder = 4,ls='-',\
#         color = blendClr(matica99G,clrWhite,0.5),linewidth=lws)
#


ax1.errorbar(AFM3Data[::,0],AFM3Data[::,1],yerr=AFM3Data[:,2], fmt='o',\
             markersize=mksz, linewidth = lw, zorder = 40, \
             label = 'Data', color = matica99C)
ax1.plot(AFM3Data[::,0],AFM3Data[::,1],'o', color='white', \
         markersize=2, zorder = 41 )

ax1.plot(AFM3Thry[::,0],AFM3Thry[::,1], zorder = 4,ls='-', \
         color = blendClr(matica99C,clrWhite,0.5),linewidth=lws)



ax3 = fig.add_subplot(223, aspect='auto')
ax3.errorbar(S2N4Data[::,0],S2N4Data[::,1],yerr=S2N4Data[:,2], fmt='o',\
             markersize=mksz, linewidth = lw, zorder = 40,\
             label = 'Data', color = matica99D)
ax3.plot(S2N4Data[::,0],S2N4Data[::,1],'o', color='white',\
         markersize=2, zorder = 41 )

ax3.plot(S2N4Thry[::,0],S2N4Thry[::,1], zorder = 4,ls='-',\
         color = blendClr(matica99D,clrWhite,0.5),linewidth=lws)




ax3.errorbar(NeelN4Data[::,0],NeelN4Data[::,1]*4,yerr=NeelN4Data[:,2]*4, fmt='o',\
             markersize=mksz, linewidth = lw, zorder = 40,\
             label = 'Data', color = matica99H)
ax3.plot(NeelN4Data[::,0],NeelN4Data[::,1]*4,'o', color='white', \
         markersize=2, zorder = 41 )

ax3.plot(NeelN4Thry[::,0],NeelN4Thry[::,1]*4, zorder = 4,ls='-',\
...
ax1.set_xticks(np.linspace(0,500,9))
xtickLabs=['-13.2','-6.8','-0.5','6.0','12.3',\
           '6.0','-0.6','-6.8','-13.2']
ax1.set_xticklabels(xtickLabs)
#ax2.set_xlabel('g (E-U)/J')
ax1.set_ylabel('Pop(state)')
ax1.set_title('Spin States Populations')
...
ax3.set_xticks(np.linspace(0,500,9))
xtickLabs=['-13.2','-6.8','-0.5','6.0','12.3',\
           '6.0','-0.6','-6.8','-13.2']
ax3.set_xticklabels(xtickLabs)
ax3.set_xlabel('g=(E-U)/J')
ax3.set_ylabel('NeelOrder or S_2')
...
plt.savefig('IsingFigN4N5v2.pdf')
