...
% h: upper bound "parallel"
    ...
    outofsight_outofmind = -1000; %PMP hack to suppress error bar cross bars, shfit out of plot
    ...
    perp(4:9:end,:) = vh;
    perp(5:9:end,:) = vl;
    perp(4:9:end,:) = outofsight_outofmind;
    perp(5:9:end,:) = outofsight_outofmind;
    perp(6:9:end,:) = NaN;
    perp(7:9:end,:) = vh;
    perp(8:9:end,:) = vl;
    perp(7:9:end,:) = outofsight_outofmind;
    perp(8:9:end,:) = outofsight_outofmind;
    perp(9:9:end,:) = NaN;
end
