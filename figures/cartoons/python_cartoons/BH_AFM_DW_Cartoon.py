...
atomLocs = np.linspace(0.5-NS/2.0,NS/2.0-0.5,NS)+0.5
...
for ii in atomList:    
    atom_shdw_x, atom_shdw_y = atomShadow(atomLocs[ii],E1+aHO[ii],dw_shdw,dw_shdw,0)
    ax.fill(atom_shdw_x, atom_shdw_y, alpha=1, facecolor = 'white',
        edgecolor='white', linewidth=0, zorder=10)

    atom_x, atom_y = atomSolid(atomLocs[ii],E1+aHO[ii],dw_atom,dw_atom,0)
    ax.fill(atom_x, atom_y, alpha=0.8, facecolor = atomGreen, \
        edgecolor=atomGreen, linewidth=0, zorder=12)
