...
mus1b = np.linspace(0,0.4,100)
mus1t = np.linspace(1,0.4,100)

ax1.plot(ujC(mus1,1),mus1, ls='-', color = 'black')

ax1.fill_between(ujC(mus1b,1), mus1b, mus1t, \
                 color = 'gray', \
                 alpha = axbs_alpha, \
                 zorder = 0)
...
mus2=np.linspace(1,2,100)

mus2b = np.linspace(1,1.45,100)
mus2t = np.linspace(2,1.45,100)

ax1.plot(ujC(mus2,2),mus2, ls='-', color = 'black')

ax1.fill_between(ujC(mus2b,2), mus2b, mus2t, \
                 color = 'gray', \
                 alpha = axbs_alpha, \
                 zorder = 0)
...
ax1.fill_between(ujC(mus4b,4), mus4b, mus4t, \
                 color = 'gray', \
                 alpha = axbs_alpha, \
                 zorder = 0)
