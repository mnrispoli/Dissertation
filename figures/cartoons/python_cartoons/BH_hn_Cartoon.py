...
yg = np.exp(-((xx-a_latt*3/2)*2*np.pi)**2)*aoff
...
atom_shdw_x, atom_shdw_y = atomShadow(atomLocs[1],E1+aoff,dw_shdw,dw_shdw,0)
ax.fill(atom_shdw_x, atom_shdw_y, alpha=1, facecolor = 'white',
        edgecolor='white', linewidth=0, zorder=10)

atom_x, atom_y = atomSolid(atomLocs[1],E1+aoff,dw_atom,dw_atom,0)
...
addGSL(E1+aoff,atomLocs[1],LG1,ax)    
