...
ax2.plot(AFM1Data[::,0],AFM1Data[::,1],'o', color='white', markersize=2, zorder = 41 )

ax2.plot(AFM1Thry[::,0],AFM1Thry[::,1], zorder = 4,ls='-', color = matica97I)



ax2.errorbar(AFM2Data[::,0],AFM2Data[::,1],yerr=AFM2Data[:,2], fmt='o',\
             markersize=mksz, linewidth = lw, zorder = 40, label = 'Data', color = matica97J)
ax2.plot(AFM2Data[::,0],AFM2Data[::,1],'o', color='white', markersize=2, zorder = 41 )

ax2.plot(AFM2Thry[::,0],AFM2Thry[::,1], zorder = 4,ls='-', color = matica97J)



ax2.errorbar(AFM3Data[::,0],AFM3Data[::,1],yerr=AFM3Data[:,2], fmt='o',\
             markersize=mksz, linewidth = lw, zorder = 40, label = 'Data', color = matica97A)
ax2.plot(AFM3Data[::,0],AFM3Data[::,1],'o', color='white', markersize=2, zorder = 41 )

ax2.plot(AFM3Thry[::,0],AFM3Thry[::,1], zorder = 4,ls='-', color = matica97A)
...
ax4.plot(S2N5Data[::,0],S2N5Data[::,1],'o', color='white', markersize=2, zorder = 41 )

ax4.plot(S2N5Thry[::,0],S2N5Thry[::,1], zorder = 4,ls='-', color = matica97F)
...
ax4.plot(NeelN5Data[::,0],NeelN5Data[::,1]*4,'o', color='white', markersize=2, zorder = 41 )

ax4.plot(NeelN5Thry[::,0],NeelN5Thry[::,1]*4, zorder = 4,ls='-', color = matica97G)
