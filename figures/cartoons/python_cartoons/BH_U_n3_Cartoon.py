...
atom_shdw_x, atom_shdw_y = atomShadow(atomLocs[1]+dux,E3+3*duy,dw_shdw,dw_shdw,0)
ax.fill(atom_shdw_x, atom_shdw_y, alpha=1, facecolor = 'white',
        edgecolor='white', linewidth=0, zorder=10)

atom_x, atom_y = atomSolid(atomLocs[1]+dux,E3+3*duy,dw_atom,dw_atom,0)
ax.fill(atom_x, atom_y, alpha=0.8, facecolor = atomGreen, \
        edgecolor=atomGreen, linewidth=0, zorder=11)



atom_shdw_x, atom_shdw_y = atomShadow(atomLocs[1]-dux,E3-duy,dw_shdw,dw_shdw,0)
ax.fill(atom_shdw_x, atom_shdw_y, alpha=1, facecolor = 'white',
        edgecolor='white', linewidth=0, zorder=12)

atom_x, atom_y = atomSolid(atomLocs[1]-dux,E3-duy,dw_atom,dw_atom,0)
ax.fill(atom_x, atom_y, alpha=0.8, facecolor = atomGreen, \
        edgecolor=atomGreen, linewidth=0, zorder=13)
...
ax.fill(atom_shdw_x, atom_shdw_y, alpha=1, facecolor = 'white',
        edgecolor='white', linewidth=0, zorder=14)

atom_x, atom_y = atomSolid(atomLocs[1]+dux,E3-3*duy,dw_atom,dw_atom,0)

ax.fill(atom_x, atom_y, alpha=0.8, facecolor = atomGreen, \
        edgecolor=atomGreen, linewidth=0, zorder=15)
...
addGSL(E3,atomLocs[1],LG3,ax)   
addGSL(E3,atomLocs[2],LG3,ax)   
...
a2 = patches.FancyArrowPatch((atomLocs[1]/2+atomLocs[2]/2,E1+DUH), (atomLocs[1]/2+atomLocs[2]/2,E3), zorder = 2, \
                             connectionstyle="arc3,rad=0", **kw)
ax.add_patch(a2)

a3 = patches.FancyArrowPatch((atomLocs[1]/2+atomLocs[2]/2,E3-DUH), (atomLocs[1]/2+atomLocs[2]/2,E1), zorder = 2, \
                             connectionstyle="arc3,rad=0", **kw)
ax.add_patch(a3)
